...
export class ApplicationSDK {
    ...
    public async getApplications() {
        ...
        return (await this.request.get('/get-applications', {
            params: {
                owner: 'admin', clientId: this.config.clientId, clientSecret: this.config.clientSecret,
            },
    ...
    public async modifyApplication(method: string, application: Application) {
        ...
        return (await this.request.post(url, {applicationInfo}, {
            params: {
                id: `${application.owner}/${application.name}`, clientId: this.config.clientId, clientSecret: this.config.clientSecret,
            },
