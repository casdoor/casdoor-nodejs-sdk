...
export class UserSDK {
    ...
    public async getAuthToken(code: string) {
        ...
        const {
            ...
            client_id: this.config.clientId, client_secret: this.config.clientSecret, grant_type: 'authorization_code', code,
    ...
    public async getUserCount(isOnline: boolean) {
        ...
        return (await this.request.get('/get-user-count', {
            params: {
                isOnline, owner: this.config.orgName, clientId: this.config.clientId, clientSecret: this.config.clientSecret,
            },
    ...
    public async modifyUser(method: string, user: User) {
        ...
        return (await this.request.post(url, {userInfo}, {
            params: {
                id: `${user.owner}/${user.name}`, clientId: this.config.clientId, clientSecret: this.config.clientSecret,
            },
